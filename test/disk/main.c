...
static int test_sync_disk() {
    return test_disk_framework("sync_disk");
}

static int test_iou_disk() {
    return test_disk_framework("iou_disk");
}
...
static test_case_t test_cases[] = {
    ...
    TEST_CASE(test_sync_disk),
    TEST_CASE(test_iou_disk),
